...
export default class MyPortfolio extends LightningElement {
    ...
    resume = 'https://github.com/gudeychaitanya147/Salesforce/raw/main/Chaitanya_Gudey_Resume.docx'

    // user data 
    username = 'Chaitanya Gudey'
    designation = 'Worked as a Salesforce Developer and Administrator'
    ...
    aboutme = [
        [   {mark: '', text: 'I am well-regarded for my strong '},
            {mark: 'highlight', text: 'problem solving and R&D skills. '},
            {mark: '', text: "I have shown the ability to quickly adapt to new work environments and enjoy learning new technologies. I'm always eager to expand my knowledge and grow both personally and professionally."}
        ],
    ...
    salesforceexp = [
        [   {mark: '', text: 'Worked as '},
            {mark: 'highlight2', text: 'Salesforce Developer '},
            {mark: '', text: 'for a duration of 2 years, where I was primarily involved in Healthcare Application. This application plays a critical role in managing the entire patient journey from lead generation to post-care services and it is also deals with essential business operations such as invoicing, billing synchronization and digital engagement.'},
        ],
        [
            {mark: '', text: 'I have actively contributed to the development and customization of applications as per the Client Requirements. My responsibilities involve implementing, optimizing and innovating business processes through '},
            {mark: 'highlight2', text: 'Flow automation and Rule-based configurations. '},
            {mark: '', text: 'Along with the usage of '},
            {mark: 'highlight2', text: 'Apex classes, Triggers and Lightning Components.'}
        ],
        [   {mark: '', text: 'For 1 year, I worked as a '},
            {mark: 'highlight2', text: 'Salesforce Administrator. '},
            ...
            {mark: '', text: 'on sandboxes and production environment. Along with Embarkation, disembarkation and changing permissions has done to new or existing users.'}
        ]
    ]
